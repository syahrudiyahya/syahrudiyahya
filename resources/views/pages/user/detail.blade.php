                    ...
                    <div class="col-lg-5 offset-lg-1"> 
                        <div class="s_product_text"> 
                            ...
                            @if ($product->discount_price && $product->discount_price < $product->price)
                                <h2 class="text-danger" style="font-size: 1.5em;">{{ number_format($product->discount_price, 0) }} Points</h2>
                                <p class="text-muted">
                                    <del style="font-size: 1.2em;">{{ number_format($product->price, 0) }} Points</del>
                                </p>
                                <p class="text-muted">Harga setelah diskon</p>
                            @else
                                <h2 style="font-size: 1.5em;">{{ number_format($product->price, 0) }} Points</h2>
                            @endif
